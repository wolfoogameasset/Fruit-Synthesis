...
public class CurrencyManager : MonoBehaviour
{
    ...
    public void RemoveCoin(int coinValue, currencySpendSource currencySpendSource)
    {
        LocalDataManager.Instance.UserLocalData.CurrentCoins -= coinValue;
        LocalDataManager.Instance.SaveLocalData();
        OnCoinDecrease?.Invoke();
        GAManagerCustom.Currency_spend(currencyType.coins.ToString(), coinValue, currencySpendSource.ToString());
    }
}
